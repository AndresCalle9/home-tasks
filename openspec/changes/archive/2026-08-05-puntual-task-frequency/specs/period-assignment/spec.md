...
at most 1, or no further eligible transfer exists. This rebalancing SHALL
only ever change which member a task is assigned to, never its assigned
day(s). The algorithm SHALL be deterministic for a given stored seed.
